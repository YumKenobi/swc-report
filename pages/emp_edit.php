...
$opt .= "</select>";
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-dark">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-dark">Edit Employee</h4>
            </div><a  type="button" class="btn btn-dark bg-gradient-dark btn-block" href="employee.php"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
            <div class="card-body">
            ...
            <form role="form" method="post" action="emp_edit1.php">
              ...
              <hr>
                ...
                <button type="submit" class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Update</button>    
                  <a href="emp_del.php?id=<?php echo $id; ?>" class="btn btn-danger btn-block"><i class="fa fa-trash fa-fw"></i>Delete</a> 
              </form>  
