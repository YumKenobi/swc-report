...
$opt .= "</select>";
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-dark">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-dark">Edit User Account</h4>
            </div><a  type="button" class="btn btn-dark bg-gradient-dark btn-block" href="user.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Back </a>
            <div class="card-body">
