...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-dark">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-dark">Edit Inventory for : <?php echo $A ?></h4>
            </div>
            <a type="button" class="btn btn-dark bg-gradient-dark" href="inv_searchfrm.php?action=edit & id='<?php echo $zzz; ?>'"><i class="fas fa-fw fa-flip-horizontal fa-share"></i> Back</a>
            ...
            <form role="form" method="post" action="inv_edit1.php">
              ...
              <div class="form-group row text-left text-dakr">
                <div class="col-sm-3" style="padding-top: 5px;">
                 On Hand:
                </div>
                <div class="col-sm-9">
              ...
              <hr>
                ...
                <button type="submit" class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Update</button>    
                  <a href="inv_del.php?id=<?php echo $id; ?>" class="btn btn-danger btn-block"><i class="fa fa-trash fa-fw"></i>Delete</a> 
              </form>  
            </div>
          </div></center>
