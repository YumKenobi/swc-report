...
?>
  ...
  <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-dark">
            ...
            <a href="product.php?action=add" type="button" class="btn btn-dark bg-gradient-dark">Back</a>
            <div class="card-body">
            ...
            <form role="form" method="post" action="pro_edit1.php">
              ...
              <hr>
                ...
                <button type="submit" class="btn btn-warning btn-block"><i class="fa fa-edit fa-fw"></i>Update</button>    
                 <a href="pro_del.php?id=<?php echo $id; ?>" class="btn btn-danger btn-block"><i class="fa fa-trash fa-fw"></i>Delete</a> 
              </form>  
            </div>
          </div></center>
